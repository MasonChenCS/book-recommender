...
void BTree::insert(Book book_, std::string balanceMode) {
...
std::vector<Book*> BTree::searchKeywords(std::vector<std::string> keywords, const std::string searchMode, const std::string matchMode) {
...
std::vector<Book*> BTree::searchApproximate(const float& key, const std::string searchMode, const unsigned int capacity) {
    std::vector<Book*> results = {};
...
Book* BTree::searchExact(const std::string& key, const std::string searchMode) {
